...
int main(){
	...
	while(1){
		...
		if(deger%2!=0){ //Bu blokta tek sayýlar ile liste oluþturma iþlemi gerçekleþir.
	...
	q->next=thead; // Bu satýrda, cift sayýlar listesinin sonuna tek sayilar listesi eklenmiþ olur.
